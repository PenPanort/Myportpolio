...
<head>
    ...
    <link rel="stylesheet" href="style_sde.css" />
    ...
    <li class="button-link"><a href="Stephe_Evina.pdf" download>Resume</a></li>
...
<body>
    ...
    <nav>
        <ul>
            ...
            <li class="button-link"><a href="#projects">Projects</a></li>
            <li class="button-link"><a href="resume.pdf" target="_blank" rel="noopener noreferrer">Resume</a></li>
        </ul>
    </nav>
    ...
    <section id="personal-info">
        ...
        <div class="personal-info">
            <p><i class="fas fa-user"></i> <strong>Full Name:</strong> Stephen Doniapon Evina</p>
            <p><i class="fas fa-hourglass-half"></i> <strong>Age:</strong> 21</p>
            <p><i class="fas fa-cake-candles"></i> <strong>Birthday:</strong> February 19, 2004</p>
            <p><i class="fas fa-heart"></i> <strong>Civil Status:</strong> Widowed</p>
            <p><i class="fas fa-map-marker-alt"></i> <strong>Address:</strong> Uvoy, Mahatao, Batanes</p>
            <p>
    ...
    <section id="skills">
        ...
        <div class="skills-container">
            <div class="skill"><i class="fas fa-code"></i> HTML &amp; CSS</div>
            <div class="skill"><i class="fas fa-database"></i> SQL</div>
            <div class="skill"><i class="fas fa-paint-brush"></i> Photoshop</div>
            <div class="skill"><i class="fas fa-tools"></i> Palitada</div>
        </div>
    </section>
    ...
    <section id="hobbies">
        ...
        <div class="hobbies-container">
            ...
            <div class="hobby">
                <i class="fas fa-8-ball"></i> Billiards
                <img src="img/billiards.jpg" alt="Billiards" />
            </div>
            <div class="hobby">
                <i class="fas fa-hiking"></i> Adventurous
                <img src="img/adphen.jpg" alt="Adventurous" />
            </div>
            <div class="hobby">
                <i class="fas fa-gamepad"></i> Online Games
    ...
    <section id="contact">
        ...
        <div class="social-icons">
            <a href="https://www.facebook.com/stephen.evina" class="fab fa-facebook" aria-label="Facebook"></a>
            <a href="https://www.instagram.com/stephen_evin" class="fab fa-instagram" aria-label="Instagram"></a>
            <a href="https://www.snapchat.com/add/stephenevina" class="fab fa-snapchat" aria-label="Snapchat"></a>
            <a href="https://github.com/PenPanort" class="fab fa-github" aria-label="GitHub"></a>
            <a href="https://www.tiktok.com/@penpanort_t=ZS-8v1O02TKAev&_r=1" class="fab fa-tiktok" aria-label="TikTok"></a>
        </div>
    </section>
    ...
    <!-- JavaScript for Profile Picture Zoom -->
    <script>
